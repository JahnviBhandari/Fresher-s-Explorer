...
// CSV format assumed: Name,Type,Rating,Distance_km
...
Place* load_places_from_csv(const char *csvfile) {
    ...
    while (fgets(line, sizeof(line), f)) {
        ...
        // Parse CSV (Name,Type,Rating,Distance_km)
...
// Simple bubble sort for distance (ascending)
...
// Simple bubble sort for rating (descending)
